    ...
    <div className="flex flex-col h-screen bg-slate-50">
      <header className="p-4 bg-white shadow-sm">
        <div className="container mx-auto">
          <h1 className="text-2xl font-semibold text-teal-600">MedVault</h1>
        </div>
      </header>

      <div className="container mx-auto flex-1 p-4">
        <div className="max-w-md mx-auto border border-slate-200 rounded-lg p-4 bg-slate-50 shadow-sm">
          <div className="space-y-3">
            <button className="w-full py-3 px-4 bg-green-700 text-white rounded-md text-left">
              <div
                onClick={() => setShowAddDepartment(true)}
                className="flex justify-between items-center"
              >
                <span className="text-lg font-medium">Add Departments</span>
                <span className="rounded-full bg-white w-6 h-6 flex items-center justify-center text-green-700">
                  +
                </span>
              </div>
            </button>
            ...
            <button
              className="w-full py-3 px-4 bg-red-50 text-red-600 border border-red-200 rounded-md text-left"
